Easily turn panoramas into triptychs or any number of pages you like. 
...
3 · SET PRINT SIZE
Pick a standard print size (e.g. 10×20"). Crop windows resize to match. Set the panorama canvas width to control DPI.

4 · ADJUST CROPS
Drag crops to reposition. Drag corners to resize. Use “Shift All Selection” to move the whole group together.
